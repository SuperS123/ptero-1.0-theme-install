...
rm -rf main.css
echo "@import url('https://raw.githubusercontent.com/SuperS123/PteroThemes/main/1.2.2/Dark-n-Purple/user.css')" >> /var/www/pterodactyl/resources/scripts/main.css
rm -rf index.tsx
